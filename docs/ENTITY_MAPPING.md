...
| `EntityType::Text` | TEXT | Point | Store text, rotation, height, style, alignment, and layer. |
| `EntityType::MText` | MTEXT | Point | Store text, rotation, height, style, alignment, and layer. |
